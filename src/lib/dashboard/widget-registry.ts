...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  },
  {
    ...
    description: "Ist-Kosten vs. Plankosten aktuelles Jahr (Wirtschaftsplan)",
    category: "kpi",
    minRole: "MANAGER",
    defaultWidth: 3,
    defaultHeight: 2,
  ...
  {
    id: "cpi-reminders",
    name: "Wertsicherungs-Anpassungen",
    description: "Fällige CPI-Anpassungen nach §9 PrKG",
    category: "list",
    minRole: "MANAGER",
    defaultWidth: 6,
    defaultHeight: 4,
  ...
  {
    id: "chart-park-comparison",
    name: "Park-Vergleich",
    description: "Monats-Produktion mehrerer Parks vergleichen (max. 5)",
    category: "chart",
    minRole: "VIEWER",
    defaultWidth: 6,
    defaultHeight: 6,
  ...
  {
    id: "chart-wirtschaftsplan-pl",
    name: "P&L Jahresverlauf",
    description: "Monatlicher Ist/Soll-Vergleich (Wirtschaftsplan)",
    category: "chart",
    minRole: "MANAGER",
    defaultWidth: 6,
    defaultHeight: 4,
