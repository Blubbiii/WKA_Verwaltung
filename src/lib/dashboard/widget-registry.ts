...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  },
  {
    id: "kpi-contracts",
    name: "Vertraege",
    description: "Anzahl aktiver Vertraege",
    category: "kpi",
    minRole: "VIEWER",
    defaultWidth: 3,
    defaultHeight: 2,
  ...
  {
    id: "list-activities",
    name: "Letzte Aktivitaeten",
    description: "Neueste Aktivitaeten im System",
    category: "list",
    minRole: "VIEWER",
    defaultWidth: 4,
    defaultHeight: 5,
  ...
  },
  {
    ...
    name: "Auslaufende Vertraege",
    description: "Vertraege die bald auslaufen",
    category: "list",
    minRole: "VIEWER",
    defaultWidth: 4,
    defaultHeight: 5,
...

  {
    ...
    description: "Ueberfaellige Rechnungen, auslaufende Vertraege und offene Abrechnungen",
    category: "list",
    minRole: "MANAGER",
    defaultWidth: 4,
    defaultHeight: 5,
  ...
  // ===========================================
  {
    id: "weather-widget",
    name: "Wetter",
    description: "Aktuelle Wetterdaten fuer Windparks",
    category: "utility",
    minRole: "VIEWER",
    defaultWidth: 3,
    defaultHeight: 3,
  ...
  },
  {
    id: "admin-audit-log",
    name: "Audit-Log",
    description: "Letzte Audit-Log Eintraege",
    category: "admin",
    minRole: "ADMIN",
    defaultWidth: 6,
    defaultHeight: 6,
...
export const WIDGET_CATEGORIES: {
  ...
  },
  {
    id: "utility",
    name: "Werkzeuge",
    description: "Nuetzliche Widgets und Schnellzugriffe",
  },
  {
    id: "admin",
    name: "Administration",
    description: "Widgets fuer Administratoren",
  },
];
