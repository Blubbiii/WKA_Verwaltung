...
export const DEFAULT_REMINDER_CONFIG: ReminderCategoryConfig[] = [
  {
    ...
    displayName: "Überfällige Rechnungen",
    description: "Rechnungen mit Status SENT deren Fälligkeitsdatum überschritten ist",
    enabled: true,
    thresholds: [
      { days: 30, urgency: "critical", label: "Mehr als 30 Tage überfällig" },
      { days: 14, urgency: "warning", label: "Mehr als 14 Tage überfällig" },
      { days: 0, urgency: "info", label: "Überfällig" },
    ],
    cooldownDays: 7,
    linkPath: "/invoices",
  },
  {
    ...
    displayName: "Auslaufende Verträge",
    description: "Aktive Verträge die bald auslaufen",
    enabled: true,
    thresholds: [
      { days: 7, urgency: "critical", label: "Läuft in weniger als 7 Tagen aus" },
      { days: 14, urgency: "warning", label: "Läuft in weniger als 14 Tagen aus" },
      { days: 30, urgency: "info", label: "Läuft in weniger als 30 Tagen aus" },
    ],
    cooldownDays: 7,
    linkPath: "/contracts",
  },
  ...
  },
  {
    ...
    enabled: true,
    thresholds: [
      { days: 7, urgency: "critical", label: "Läuft in weniger als 7 Tagen ab" },
      { days: 14, urgency: "warning", label: "Läuft in weniger als 14 Tagen ab" },
      { days: 30, urgency: "info", label: "Läuft in weniger als 30 Tagen ab" },
    ],
    cooldownDays: 7,
    linkPath: "/documents",
  },
