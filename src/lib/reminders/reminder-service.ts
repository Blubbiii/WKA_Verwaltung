  ...
  return invoices.map(
    (inv: {
      ...
      return {
        ...
        entityId: inv.id,
        entityType: "Invoice",
        title: `Rechnung ${inv.invoiceNumber} überfällig`,
        description: `${inv.recipientName || "Unbekannt"} - ${amount.toFixed(2)} EUR - ${daysOverdue} Tage überfällig`,
        urgency,
  ...
  return contracts.map(
    (contract: {
      ...
      return {
        ...
        entityType: "Contract",
        title: `Vertrag "${contract.title}" läuft aus`,
